...
CREATE TABLE BLOG_POST (ID INTEGER IDENTITY NOT NULL, POSTTEXT TEXT, BLOG_USER_ID INTEGER, VERSION INTEGER, CREATE_DATE DATE, UPDATE_DATE DATE, PRIMARY KEY (ID));
...
ALTER TABLE BLOG_POST ADD CONSTRAINT FK_BLOG_POST_USER_ID FOREIGN KEY (BLOG_USER_ID) REFERENCES BLOG_USER (ID);
